...
Partial Class Initial
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label2.Size = New System.Drawing.Size(422, 31)
        Me.Label2.TabIndex = 1
        Me.Label2.Text = "выберете из списка название фирмы для которой будет производится поверка термоэле" & _
            "ктрических преобразователей"
        '
        'Label3
        '
        ...
        Me.Label3.Text = "выберете из списка наименование термоэлектрического преобразователя поверка котор" & _
            "ого будет осуществляться"
        '
        'ChoiseOfFirm
        '
